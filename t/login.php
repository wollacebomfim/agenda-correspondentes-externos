...
<input name="usuario" type="text"   placeholder="INSIRA SEU E-MAIL" autofocus required>
</div><br>

<div class="form-field">
<label for="senha">CPF</label>
<input name="senha"  type="password"   minlength="11" maxlength="11" size="11" placeholder="INSIRA SEU CPF" required onkeypress="return onlynumber();" required > 
</div><br>
