    ...
    <option value="As partes firmaram um aditivo em data anterior ao reconhecimento do estado de calamidade pública no Brasil em decorrência da pandemia da COVID-19.">Antes de 22/03/2020</option></option>
    ...
    <label for="dataaditivo">Data do último aditivo, se houve:</label>
    </div>
...
$('select').on('change', function(){ 
  if( $(this).find('option:selected').text().indexOf('Depois') > 0) {
    ...
    <div class="input-field col s8">
    <i class="material-icons prefix"> date_range</i>
    <input type="date" name="datacumprimento" maxlength="8" size="8"  placeholder="DATA DO CUMPRIMENTO" >
     <label for="datacumprimento">Data de cumprimento da última prestação adimplida, se houver.</label>
    </div>
